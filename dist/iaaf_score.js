 ...
 */
var IAAF_JUMP_CODES = new RegExp("^(LJ|PV|TJ|HJ)$", "i");
var IAAF_THROW_CODES = new RegExp("^(WT|JT|DT|HT|SP)$", "i");
 ...
 */
var _iaaf_score = function iaaf_score(gender, event_code, value) {
    ...
    return _iaaf_score(gender, event_code, value);
};
